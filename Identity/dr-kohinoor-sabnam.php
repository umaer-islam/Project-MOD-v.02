...
<head>
  ...
  <title>Dr. Kohinoor Sabnam — Digital Identity Card</title>
  <meta name="description" content="NFC Digital Identity Card for Dr. Kohinoor Sabnam — BDS, MSc (Microbiology), Senior Dental Surgeon.">
...
<link rel="author" href="../humans.txt">
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .avatar-ring { animation: rotateRing 30s linear infinite; }
    ...
    @media (max-width: 360px) {
      .profile-header-bg { padding: 20px 16px 60px !important; }
      .avatar-ring { width: 112px !important; height: 112px !important; inset: -4px !important; }
      div[style*="width:128px;height:128px"] { width: 104px !important; height: 104px !important; border-width: 3px !important; }
      div[style*="width:128px;height:128px"] span { font-size: 34px !important; }
      .float-badge { width: 26px !important; height: 26px !important; bottom: 0 !important; right: 0 !important; }
      div[style*="margin-top:-56px"] { margin-top: -44px !important; padding: 0 12px !important; }
      div[style*="padding:28px 24px 24px"] { padding: 20px 16px 16px !important; }
      h1 { font-size: 18px !important; }
      .stagger-children span { font-size: 8px !important; letter-spacing: 0.5px !important; }
      div[style*="padding:0 20px"] { padding: 0 12px !important; }
      div[style*="padding:24px"] { padding: 16px !important; }
      #intro-card { width: 280px !important; height: 180px !important; padding: 20px !important; }
    }

    /* Responsive styling for desktop/tablet screens */
  ...
  <div id="intro-overlay">
    ...
    <div id="intro-card">
      ...
      <div style="text-align:center;">
        <div style="color:#fff;font-family:'Playfair Display',serif;font-size:16px;font-weight:700;letter-spacing:0.5px;">Dr. Kohinoor Sabnam</div>
        <div style="color:rgba(234,116,27,0.8);font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:3px;margin-top:4px;">Dental Surgeon</div>
      </div>
  ...
  <div class="profile-wrapper" id="profile-main">
      ...
      <div class="reveal-scale" style="text-align:center;margin-top:36px;">
        <div style="position:relative;display:inline-block;">
          ...
          <div style="width:128px;height:128px;border-radius:50%;background:linear-gradient(135deg, #f0f4f8, #e2e8f0);border:4px solid rgba(255,255,255,0.6);display:flex;align-items:center;justify-content:center;box-shadow:0 12px 40px rgba(0,0,0,0.15);position:relative;">
            <span style="font-family:'Playfair Display',serif;font-size:42px;font-weight:700;color:var(--navy);user-select:none;">KS</span>
          </div>
    ...
    <div style="padding:0 20px;margin-top:-56px;position:relative;z-index:10;">
      <div class="reveal" style="background:var(--card);border-radius:24px;padding:28px 24px 24px;box-shadow:var(--shadow-md);border:1px solid var(--border);text-align:center;">
        <h1 style="font-family:'Playfair Display',serif;font-size:24px;font-weight:700;color:var(--text);line-height:1.3;margin:0;">
          Dr. Kohinoor Sabnam
        </h1>
        ...
        <p style="color:var(--text-muted);font-size:11px;margin-top:4px;font-weight:500;">
          BDS (City Dental College) · MSc (Microbiology)
        </p>
        ...
        <div style="display:inline-flex;align-items:center;gap:6px;margin-top:12px;padding:6px 14px;background:#f0f4f8;border:1px solid var(--border);border-radius:99px;">
          ...
          <span style="color:var(--navy);font-weight:800;font-size:11px;letter-spacing:1px;">A-4152</span>
        </div>
        ...
        <div class="stagger-children" style="display:flex;gap:0;margin-top:20px;border-top:1px solid var(--border);padding-top:16px;">
          ...
          <a href="tel:+8801712313528" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:4px;text-decoration:none;padding:8px 4px;border-radius:12px;transition:background 0.3s;" onmouseover="this.style.background='rgba(0,69,145,0.04)'" onmouseout="this.style.background='none'">
          ...
          <a href="https://wa.me/8801712313528?text=Hello%2C%20I%20would%20like%20to%20book%20a%20consultation%20with%20Dr.%20Kohinoor%20Sabnam." target="_blank" style="flex:1;display:flex;flex-direction:column;align-items:center;gap:4px;text-decoration:none;padding:8px 4px;border-radius:12px;transition:background 0.3s;" onmouseover="this.style.background='rgba(37,211,102,0.05)'" onmouseout="this.style.background='none'">
    ...
    <div style="padding:0 20px;margin-top:20px;display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="stagger-children" style="display:flex;flex-direction:column;gap:2px;">
          <div class="info-row" style="display:flex;align-items:flex-start;gap:12px;">
            ...
            <div>
              ...
              <p style="font-size:12px;color:var(--text-muted);margin-top:2px;">City Dental College</p>
            </div>
          </div>
          <div class="info-row" style="display:flex;align-items:flex-start;gap:12px;">
            <div style="width:8px;height:8px;border-radius:50%;background:var(--navy);flex-shrink:0;margin-top:6px;"></div>
            <div>
              <p style="font-size:14px;font-weight:600;color:var(--text);">MSc (Microbiology)</p>
              <p style="font-size:12px;color:var(--text-muted);margin-top:2px;">Advanced study in medical microbiology & sterilization</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="reveal" style="background:var(--card);border-radius:22px;padding:24px;box-shadow:var(--shadow-sm);border:1px solid var(--border);">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;">
          ...
          <h3 style="font-family:'Playfair Display',serif;font-size:16px;font-weight:700;color:var(--text);">Professional Roles</h3>
        </div>
        <div class="stagger-children" style="display:flex;flex-direction:column;gap:2px;">
          <div class="info-row" style="display:flex;align-items:center;gap:12px;">
            <div style="width:32px;height:32px;border-radius:10px;background:#f0f4f8;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-user-doctor" style="color:var(--navy);font-size:12px;"></i>
            </div>
            <div style="flex:1;">
              <p style="font-size:13px;font-weight:600;color:var(--text);">Senior Dental Surgeon</p>
              <p style="font-size:11px;color:var(--text-muted);">Mamun's Ortho Dental Center</p>
            </div>
            <i class="fas fa-chevron-right" style="color:#cbd5e1;font-size:10px;"></i>
          </div>
          <div class="info-row" style="display:flex;align-items:center;gap:12px;">
            <div style="width:32px;height:32px;border-radius:10px;background:#f0f4f8;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-shield-halved" style="color:var(--orange);font-size:12px;"></i>
            </div>
            <div style="flex:1;">
              <p style="font-size:13px;font-weight:600;color:var(--text);">Expert General Dental Care</p>
              <p style="font-size:11px;color:var(--text-muted);">Restorative, extraction, scaling & root canals</p>
            </div>
            <i class="fas fa-chevron-right" style="color:#cbd5e1;font-size:10px;"></i>
          </div>
        </div>
      ...
      <div class="reveal" style="background:var(--card);border-radius:22px;padding:24px;box-shadow:var(--shadow-sm);border:1px solid var(--border);">
        ...
        <div class="stagger-children" style="display:flex;flex-direction:column;gap:2px;">
          ...
          <a href="tel:+8801712313528" class="info-row" style="display:flex;align-items:center;gap:12px;text-decoration:none;color:inherit;">
            <i class="fas fa-phone" style="color:var(--navy);font-size:13px;width:16px;text-align:center;"></i>
            <p style="font-size:13px;color:var(--text);font-weight:500;">+880 1712-313528</p>
          </a>
    ...
    <footer class="reveal" style="padding:32px 20px 28px;text-align:center;">
      ...
      <a href="https://tapyzon.top" target="_blank" style="display:inline-flex;align-items:center;gap:4px;margin-top:8px;padding:5px 14px;background:rgba(0,69,145,0.04);border:1px solid var(--border);border-radius:99px;text-decoration:none;font-size:10px;color:#94a3b8;font-weight:600;transition:all 0.3s;" onmouseover="this.style.borderColor='rgba(234,116,27,0.3)'" onmouseout="this.style.borderColor='var(--border)'">
        ...
        <span style="color:#cbd5e1;font-weight:400;">(tapyzon.top)</span>
      </a>
    </footer>
  </div>
...
VERSION:3.0
N:Sabnam;Kohinoor;Dr.;;
FN:Dr. Kohinoor Sabnam
...
END:VCARD`;
      ...
      a.href = url;
      a.download = 'Dr_Kohinoor_Sabnam.vcf';
    ...
    function shareCard() {
      const shareData = {
        title: 'Dr. Kohinoor Sabnam - Digital Identity',
        text: 'Save contact and book appointment with Dr. Kohinoor Sabnam.',
